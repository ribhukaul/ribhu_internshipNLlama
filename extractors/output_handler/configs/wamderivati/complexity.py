...
complexity = {
    ...
    "sections": 
    {
        "section0": {
            ...
            "list": ['isin', 'descrizione', 'tipotitolo', 'emittente', 'idemittente', 'divisa', 'mercato', 'quotato', 'valorenominale', 'garanziaminimaperc', 'garantito', 'protezionecondizionataperc', 'barrieraprotezioneperc', 'tipobarrieraprotezione', 'levacapitale', 'levaperccapitale', 'levacedolare', 'levaperccedolare', 'cedolagarantitaperc', 'cedolacondizionataperc', 'barrieracedolacondizionataperc', 'memorycoupon', 'cedolacapperc', 'codicesottostante', 'nomesottostante', 'divisasottostante', 'tiposottostante', 'sottostantebasket', 'numerosottostanti', 'tipocalcolobasketperf', 'sottostanteopaco', 'posizionelongshortsusottostante', 'strategialongshort', 'isquanto', 'pathdependent', 'tiporilevazione', 'finecollocamento', 'dataemissione', 'datascadenza', 'automaticearlyredemption', 'tipopayoff', 'datainserimento', 'classeeusipa', 'tipo_idemittente', 'bailin', 'rankingbailin', 'strike', 'cedolafloorperc', 'openend', 'callable', 'putable', 'creditlinked', 'decodifica', 'retail', 'defaulted', 'note', 'fare', 'farebailin']
        },
        "section1": {
            "name": "Anagrafica Sottostanti",
            "list": ['sottostante_1(anagraficasottostanti)', 'sottostante_2(anagraficasottostanti)', 'sottostante_3(anagraficasottostanti)', 'sottostante_4(anagraficasottostanti)', 'sottostante_5(anagraficasottostanti)']
